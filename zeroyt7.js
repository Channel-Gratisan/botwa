        ...
        let fakegroup = (teks) => {
            zeroyt7.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283120857907-1604595598@g.us" } : {})
                    },
                    message: {
                        "imageMessage": {
                            "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
...
costum(buffer, sticker, Verived, `Jangan Lupa Bahagia`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
button = [
  {buttonId: '.youtube', buttonText: {displayText: '☰ TELEGRAM'}, type: 1},
  {buttonId: '.instagram', buttonText: {displayText: '☰ GC TELE'}, type: 1},
  {buttonId: '.tiktok', buttonText: {displayText: '☰ GRUP WHATSAPP'}, type: 1}
]
 buttons = {
...
zeroyt7.sendMessage(`6283120857907@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'youtube':
teks =
`Nih TelegramKu https://t.me/MasWayVPN`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Channel Tele Ya https://t.me/MasWayTesti`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Grub WA Ya https://chat.whatsapp.com/Iayb7CPcWs49ecklPY4dVS`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
